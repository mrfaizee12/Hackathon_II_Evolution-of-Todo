"""
Structured logging for Reminder Service
"""
...
def setup_logging(level=logging.INFO):
    """
    Set up structured logging for the Reminder Service
    """
...
def log_reminder_scheduled(reminder_id: str, task_id: str, user_id: str, 
                         scheduled_time: str, correlation_id: str = None):
    """
    Log a reminder being scheduled
    """
...
def log_reminder_sent(reminder_id: str, task_id: str, user_id: str, 
                     method: str, correlation_id: str = None):
    """
...
def log_notification_sent(notification_id: str, user_id: str, method: str, 
