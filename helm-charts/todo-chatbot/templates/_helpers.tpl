...
*/}}
{{- define "todo-chatbot.postgresql.secretName" -}}
{{- printf "%s-postgresql-secret" (include "todo-chatbot.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
OpenRouter secret name
*/}}
{{- define "todo-chatbot.openrouter.secretName" -}}
{{- printf "%s-openrouter-secret" (include "todo-chatbot.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}